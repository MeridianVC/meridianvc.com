      ...
      <footer style={footerStyle} className="footer">
        <div style={leftContainerStyle} className="footer-left-flex-column">
          <div style={sectionStyle} className="footer-small-remove">
            <Text variant="BodyBaskerville">Legal</Text>
            <Text variant="SmallBaskerville">
              The Founders and other third-parties have not received compensation for this feedback and have not
              invested in the Fund, although the Founders and other third-parties may have an incentive to make a
              positive statement due to their ongoing relationship with the firm. The companies identified do not
              represent all of the companies purchased, sold, or recommended for portfolios advised by the Firm. The
              Firm&apos;s complete track record and companies comprising the portfolio of each fund is available upon
              request. The reader should not assume that all investments in the companies identified were or will be
              profitable. Past performance is not indicative of future performance.
            </Text>
          </div>
          <div style={sectionStyle}>
            <Text variant="BodyBaskerville">About</Text>
            <Text variant="SmallBaskerville" style={{ marginBottom: '10px' }}>
              At Meridian, we empower audacious founders who are at the forefront of building durable technologies that
              positively impact humanity. We believe that visionary founders are the architects of the future, and it’s
              our privilege to support them. As an early-stage venture capital firm, we specialize in investing in B2B
              software companies from Pre-Seed to Series A.
            </Text>
            <Text variant="BodyBaskerville">Ethos</Text>
            <Text variant="SmallBaskerville">
              Integrity, relentless work ethic, entrepreneurship, accountability, and a commitment to learning.
            </Text>
          </div>
          <div style={linkGroupStyle}>
            <Text variant="BodyBaskerville">Links</Text>
            <a
            ...
            <a
              href="mailto:info@meridianvc.com"
              target="_blank"
              style={linkStyle}
              className="footer-link"
              rel="noreferrer">
            ...
            <a
              href="https://medium.com/@devon_45585"
              target="_blank"
              style={linkStyle}
              className="footer-link"
              rel="noreferrer">
        ...
        <div style={rightContainerStyle} className="footer-right-flex-column">
          ...
          <div style={preparedBySectionStyle} className="prepared-by-section">
            ...
            <a
              href="https://www.linkedin.com/in/devon-gethers/"
              target="_blank"
              className="footer-link"
              rel="noreferrer">
